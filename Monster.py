...
class Monster():
  ...
  def update(self, player):
    ...
    if ability_ultimate_b == False:
      ability_number = random.randint(0,2)
...
class SmolBean(Monster):
  def __init__(self):
    Monster.__init__(self, 
                     ...
                     20, 
                     11, 
                     {"Mushy": 10, "Sugar snap": 7, "Vine wrap": 11}, 
                     ["Mushy", "Sugar snap", "Vine wrap"], 
                     {"Legumes in a pod" : 17}, 
                     ["Legumes in a pod"], 
                     "The SmolBean uses mushy. You have been mushified. You nor smolbean knows what this means. It deals 10 damage...", 
                     "SNAP, you have been sugared! SmolBean attcks with valiance trying its very best :) It deals a mere 7 damage.", 
                     "Smol bean calls upon its old pea pod plant and orders for its vines to entrap you. Seeing this makes you want to go awwh. Regradless, it deals a hefty 11 damage.", 
                     "Hark! what is this... SmolBean sees you are a tough oponent and uses its most powerful attck. It beckons its siblings from its very own mother pea plant and they fly toward you. As they valiantly try to help their dear brother they DIE TRYING... This does no inital damage to you however seeing this pointless effort in vein gives you a feeling of emptiness. It deals 17 EMOTIONAL DAMAGE (Note: EMOTIONAL DAMAGE works the same as normal damage).")